...
class load_data(tk.Frame):
    ...
    def __init__(self, parent, controller):  # Define all the controller in the load_data window
        ...
        label2 = ttk.Label(self, text="X Sample Length (nm)", font="Small_Font", background='#ffffff')
        label2.pack(pady=10, padx=10)
        txtxactual = ttk.Entry(self)
        txtxactual.pack()

        label3 = ttk.Label(self, text="Y Sample Length (nm)", font="Small_Font", background='#ffffff')
        label3.pack(pady=10, padx=10)
