...
class data_cleaning(tk.Frame):
    ...
    def export_cleaned_data(self, file, Ddriftx, Ddrifty, Phase_reduced_array_retract_D, Amp_reduced_array_retract_D, Dcorrected_array, Dlinearized, export_filename0, CROP):
        global xSIZE
        global ySIZE
        global zSIZE
        global Xnm
