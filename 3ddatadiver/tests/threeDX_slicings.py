...
def threeDX_slicings(filename, z_dir, location_slices, export_filename2, x_actual, y_actual, x_size, y_size):
    ...
    As = np.array(create_pslist.create_pslist(filename,x_size, y_size))[0:len(Z_dir), location_slices, :].flatten()
