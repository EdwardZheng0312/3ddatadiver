...
def threedyslicings(filename, z_dir, location_slices, export_filename2, x_actual, y_actual, x_size, y_size):
        ...
        Bs = np.array(createpslist.createpslist(filename, x_size, y_size))[0:len(Z_dir), :, location_slices].flatten()
