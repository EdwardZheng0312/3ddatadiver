...
class data_cleaning(tk.Frame):
    ...
    def get_source(self, source, export_filename, controller):
        ...
        Zarraytotcorr, indZ = self.correct_slope(Zsnsr_threeD_array)
        Darraytotcorr, indD = self.correct_slope(Drive_threeD_array)
    ...
    def correct_slope(self, target_threeD_array):
